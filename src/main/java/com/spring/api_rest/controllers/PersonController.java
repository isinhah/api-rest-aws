package com.spring.api_rest.controllers;

import com.spring.api_rest.services.PersonServices;
...
@Tag(name = "People", description = "Endpoints fo Managing People")
public class PersonController {
    ...
    @PostMapping(value = "/v2", consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE },
            produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
    @Operation(summary = "Adds a new Person with Birthday attribute",
            description = "Adds a new Person by passing in a JSON, XML or YML representation of the person!",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
